...
import com.template.states.PolicyReceiverRole
...
@StartableByRPC
class AssignPolicyIReceiverRole(
    ...
    override fun call(): SignedTransaction {
        ...
        return subFlow(ModifyRolesFlow(membershipId, membershipState.roles + PolicyReceiverRole(), notary))
    }
}